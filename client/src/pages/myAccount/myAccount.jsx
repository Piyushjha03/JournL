...
export const MyAccount = () => {
  ...
  async function uploadimage() {
    ...
    try {
      await axiosWithoutCredentials
        .post("https://api.cloudinary.com/v1_1/dhxgnzie8/image/upload/", data, {
          headers: {
              ...
              {isEditable ? (
                <>
                  ...
                  <div className={styles.userPass_right}>
                    <div className={styles.pass_card_text}>JournL Card</div>
                    <div className={styles.firstName}>
                      First Name:{" "}
                      <input
                        type="text"
                        name="firstName"
                        className={styles.firstName_input}
          ...
          {addTrack ? (
            ...
            <button onClick={postPost}>post</button> */}
                  ...
                  <>
                    ...
                    <div className={styles.trackCard_Name}>Add Image</div>
                  </>
                )}
              </div>
            </>
