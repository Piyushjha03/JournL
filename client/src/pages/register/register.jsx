    ...
    <div className={style.register_page_wrapper}>
             ...
             <form className={style.register_form} >
                   ...
                   <input type="text" name="lastName" placeholder='Lastname' onChange={(e)=>handleChange(e)}/>
                     ...
                     <input type="username" name="userName" placeholder='Username' onChange={(e)=>handleChange(e)}/>                     <input type="password" name="password" placeholder='Password' onChange={(e)=>handleChange(e)}/>
                     <button className={style.createAccount_bttn} onClick={(e)=>handleSignUp(e)}>
                    
                         <span className={style.register_bttn_text}>CREATE ACCOUNT</span>

                        </button>
                     <button className={style.gotoLogin_bttn}  onClick={()=>{navigate('/login')}}>
